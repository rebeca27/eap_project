...
import com.eap.project.repository.EmployeeRepository;
...
public class EmployeeResourceIntTest {
    ...
    public void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getCnp()).isEqualTo(DEFAULT_CNP);
    ...
    public void updateEmployee() throws Exception {
        ...
        assertThat(testEmployee.getCnp()).isEqualTo(UPDATED_CNP);
